...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form class="row g-3" method="POST" action="{{ ($item && $item->id)?route('trailer.update', $item->id):route('trailer.store') }}">
                @csrf
                <div class="col-md-6">
                ...
                <input type="hidden" name="type" value="{{\App\Models\Transport::TRAILERS}}" />
                <div class="col-md-12">
